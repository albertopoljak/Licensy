...
Main
"""
print("NOTICE: If you still have licenses in your license list.txt file, then those will be invalidated if more are generated.")
print("----------------------------------------------------------")
...
print("I recommend resaving the active licenses in a new file for distribution.")
print("----------------------------------------------------------")
